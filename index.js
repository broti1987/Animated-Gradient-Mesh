...
const fragmentShader = `
  ...
  void main() {
    ...
    vec3 c1 = vec3(0.949, 0.961, 0.969);  // #F2F5F7
    vec3 c2 = vec3(0.980, 0.820, 0.851);  // #FAD1D9
    vec3 c3 = vec3(0.961, 0.643, 0.698);  // #F5A4B2
    vec3 c4 = vec3(0.647, 0.729, 0.976);     // #A5BAF9
    vec3 c5 = vec3(0.831, 0.859, 0.945);  // #D4DBF1
    vec3 c6 = vec3(1.0, 0.839, 0.612);  // #FFD69C
